    ...
    >
      {data.map((c, i) => (
        ...
        >
          ...
          <div className="relative z-20 flex-1 p-[10px] box-border">
            <img
              src={c.image}
              alt={c.title}
              loading="lazy"
          ...
          <footer className="relative z-20 p-3 text-white font-sans grid grid-cols-[1fr_auto] gap-x-3 gap-y-1">
